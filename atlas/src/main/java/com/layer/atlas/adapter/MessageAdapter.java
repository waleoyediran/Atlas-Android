 ...
 */
public class MessageAdapter extends BaseAdapter<Message, MessageViewHolder> implements InteractionListener<Message> {
    ...
    public MessageAdapter(Context context, LayerClient client, ViewHolderFactory factory, DataSource dataSource, Listener listener) {
    ...
    /**
     * Request the view type for this Message from this Adapter's ViewHolderFactory.
     *
     * @param message The Message to determine a view type for.
     * @return The view type supplied by the ViewHolderFactory.
     */
    @Override
    public int getItemViewType(Message message) {
        return mFactory.getMessageViewType(this, message);
    }
    ...
    public MessageViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        MessageViewHolder viewHolder = mFactory.createMessageViewHolder(this, mContext, viewType);
    ...
    public void onBindViewHolder(MessageViewHolder viewHolder, Message message) {
        viewHolder.setInteractionTarget(message);
    ...
    public static interface ViewHolderFactory {
        public int getMessageViewType(MessageAdapter adapter, Message message);

        public MessageViewHolder createMessageViewHolder(MessageAdapter adapter, Context context, int viewType);
    }
