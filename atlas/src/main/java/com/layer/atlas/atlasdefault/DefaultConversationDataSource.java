...
public class DefaultConversationDataSource implements ConversationQueryAdapter.DataSource {
    ...
    @Override
    public AvatarItem getConversationAvatarItem(ConversationQueryAdapter adapter, final Conversation conversation) {
