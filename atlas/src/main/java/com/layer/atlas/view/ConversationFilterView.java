...
public class ConversationFilterView extends EditText implements TextWatcher {
    private final static int DEF_STYLE = R.attr.conversationFilterViewStyle;
    ...
    public static interface Callback {
         ...
         */
        public void onAfterTextChanged(ConversationFilterView toolbar, Editable input);
    }
    ...
    public ConversationFilterView(Context context, AttributeSet attrs) {
        this(context, attrs, DEF_STYLE);
    }

    public ConversationFilterView(Context context, AttributeSet attrs, int defStyleAttr) {
